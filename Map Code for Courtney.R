...
setwd('M:/FEB/Spalding/Census CoN 2024')
...
colors <- c("lightyellow", "orange", "navyblue")

# Create the map
intexpmap<- tm_shape(md_base) +
  tm_borders(lwd = 0.5, col = "grey60") +  # Add county borders
  tm_fill(col = "value", style = "fixed", breaks = breaks, palette = colors,
          title = "Change in Direct Sales, 2017-2022", labels = labels,
